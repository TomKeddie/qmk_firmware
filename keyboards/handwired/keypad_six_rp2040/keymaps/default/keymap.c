...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = { { KC_F20, KC_F20, KC_F21, KC_F22, KC_F23, KC_F24, /*SAFE_RANGE, SAFE_RANGE+1*/ KC_A, KC_B } }
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    uprintf("%s: kc: 0x%04X, col: %u, row: %u, pressed: %d, time: %u, interrupt: %d, count: %u modifier %d\n",
